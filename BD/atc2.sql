...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 21 2023 г., 14:56
...
(2, 'Смит', 'Джон', 'Тимофеевич', 'admin', '$2y$10$OurQh7xrrrGbynGoG5EJuewVvcI3R3TGLHpvCLiQw6cmFW82A97lC', 1, '2023-11-01', 2, 1, 1),
...
--
ALTER TABLE `user`
  MODIFY `user_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
